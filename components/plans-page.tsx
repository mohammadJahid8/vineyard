...
export default function PlansPage() {
  ...
  return (
    <>
      <div className='min-h-screen bg-gradient-to-br from-vineyard-50 via-white to-vineyard-100 py-8'>
      ...
      {userPlanInfo?.isSubscriptionActive && <BottomNavigation />}
    </>
  );
}
